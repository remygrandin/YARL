...
```bash
PHASE_INFO=$(node "C:/Users/remyg/Documents/Projet/YARL/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node "C:/Users/remyg/Documents/Projet/YARL/.claude/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}")
...
```bash
PHASE_DIR=$(node "C:/Users/remyg/Documents/Projet/YARL/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}" --raw)
```
